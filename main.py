...
output_path = r'C:\Users\ahmed\PycharmProjects\scrappingImages\images'
...
#####################################################
# connecting to mongo and retriving names of entity
#####################################################
...
mydb = client["sanctions_db"]
collection = mydb["sanction_entities"]
search_terms = collection.distinct("full_name")
print("names are :", search_terms)
...
DRIVER_PATH = r'C:\Users\ahmed\PycharmProjects\scrappingImages\webdrive\chromedriver.exe'
...
def search_and_download(search_term: str, target_path="./images", number_images=5):
    ...
    with webdriver.Chrome(executable_path=DRIVER_PATH) as wd:
        ...
        print("images_url",res,"term",term)

        collection.update_many({"full_name": str(term)}, {"$set": {"img_url": list(res)}})
        # Download the images.
        if res is not None:
            for elem in res:
